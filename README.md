...
**유니버스.** `data/us_exchanges.json` 의 미국 상장 심볼에서 출발해 가격 $5 이상,
60일 평균 거래대금 $10M 이상, 관측 130거래일 이상만 남깁니다. 안 거르면 거래 없는
잡주가 우연히 상위권에 뜹니다. 회사명·섹터·산업은 Finviz 에서, 막히면 커밋된
스크리너 스냅샷(flat/base/turnaround/highs)에서 가져옵니다.
