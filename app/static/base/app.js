...
const GLOSSARY = {
  ...
  "분출 여부": "엄격 기준으로 이미 급등했는지: 5일 +10%↑ / 10일 +12%↑ / 50일선 +12%↑ / 피봇 돌파·과열 / 베이스 상단 분출(상단 ≥92%에서 5일 +15%↑) 중 하나라도 걸리면 '분출'로 감점. 단, 거래량 실린 '깨끗한 포켓피벗'(하루 상승)은 진짜 분출(5일 +15%↑) 전까지는 감점 없이 '포켓피벗'으로만 표시.",
  "단기 5일/10일": "최근 5거래일·10거래일 수익률. 크면 이미 튄 것(분출).",
  "최근10일 변동폭": "최근 10일 (고가−저가)/현재가. 작을수록 타이트하게 눌려 있음.",
  "베이스 내 위치": "현재가가 베이스 저점(0%)~고점(100%) 중 어디인지. 상단(≥92%)에서 5일 +15%↑로 치고 올라왔으면 분출. 하루짜리 포켓피벗은 해당 없음.",
};
